...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"<< Primero",sLast:"Último >>",sNext:"Siguiente >",sPrevious:"< Previo"},sEmptyTable:"No hay datos disponibles en la tabla.",sInfo:"Mostrando _START_ - _END_ de un total de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 - 0 de un total de 0 entradas",sInfoFiltered:"(Filtradas de un total de _MAX_ entradas)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ entradas",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:'<i class="fa fa-search"></i>',sSearchPlaceholder:"Buscar",sUrl:"",sZeroRecords:"No hay entradas relacionadas con la búsqueda."},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
